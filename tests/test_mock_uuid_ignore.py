"""Tests for mock_uuid fixture ignore list functionality."""

from __future__ import annotations


class TestMockUUIDIgnore:
    """Tests for mock_uuid.set_ignore() functionality."""

    def test_mock_uuid_ignore_single_module(self, pytester):
    ...
    def test_mock_uuid_ignore_multiple_modules(self, pytester):
    ...
    def test_mock_uuid_ignore_updates_dynamically(self, pytester):
    ...
    def test_mock_uuid_ignore_with_reset(self, pytester):
    ...
    def test_mock_uuid_ignore_with_nested_calls(self, pytester):
    ...
    def test_mock_uuid_calls_tracking_with_ignore(self, pytester):
